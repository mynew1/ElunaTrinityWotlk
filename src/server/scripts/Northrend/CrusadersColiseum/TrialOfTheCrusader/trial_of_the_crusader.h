...
{
    {563.912f, 176.625f, 394.73f, 4.70437f},  //  0 Center
    {575.451f, 176.496f, 394.73f,  4.6541f},  //  1 Left
    {549.951f,  176.55f, 394.73f, 4.74835f}   //  2 Right
};
...
const Position ToCCommonLoc[]=
{
    ...
    {577.347839f, 176.338888f, 395.14f, 0},     //  3 - Right
    {550.955933f, 176.338888f, 395.14f, 0},     //  4 - Left
    {563.833008f, 176.244995f, 394.585561f, 0}, //  5 - Center
    {573.5f, 180.5f, 395.14f, 0},               //  6 Move 0 Right
    {553.5f, 180.5f, 395.14f, 0},               //  7 Move 0 Left
    {573.0f, 185.0f, 395.14f, 0},               //  8 Move 1 Right
    {555.5f, 185.0f, 395.14f, 0},               //  9 Move 1 Left
